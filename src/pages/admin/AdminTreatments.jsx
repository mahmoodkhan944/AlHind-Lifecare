          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="text-left border-b bg-muted">
                <th className="p-4 font-medium text-muted-foreground">Treatment</th>
            ...
            <tbody className="divide-y">
              ...
              {filtered.length === 0 && (
                <tr><td colSpan={5} className="p-8 text-center text-muted-foreground/70">No treatments found. Click "Add New Treatment" to create one.</td></tr>
              )}
            </tbody>
          </table>
        </div>

          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="text-left border-b bg-gray-50">
                ...
                <th className="p-4 font-medium text-gray-500">Speciality</th>
                <th className="p-4 font-medium text-gray-500">Hospital</th>
                <th className="p-4 font-medium text-gray-500">Experience</th>
            ...
            <tbody className="divide-y">
              {paginated.map((item) => (
                <tr key={item.id} className="hover:bg-gray-50">
                  ...
                  <td className="p-4 text-gray-600">{item.hospital_name || "-"}</td>
                  <td className="p-4 text-gray-600">{item.experience_years ? `${item.experience_years} yrs` : "-"}</td>
                  <td className="p-4">
              ...
              {filtered.length === 0 && (
                <tr><td colSpan={6} className="p-8 text-center text-gray-400">No doctors found. Click "Add New Doctor" to create one.</td></tr>
              )}
            </tbody>
          </table>
        </div>

// Comprehensive list of countries with ISO code, flag emoji, and dialing code
export const COUNTRIES = [
  {name: "Select Country", code: "", dial: "", flag: ""},
  ...
  { name: "Congo (Congo-Brazzaville)", code: "CG", dial: "+242", flag: "🇨🇬" },
...
export function getDialCode(name) {
  ...
  // FIX: the placeholder entry ({name: "Select Country", dial: ""}) matched
  // successfully here, so `c` was truthy but `c.dial` was an empty string —
  // the "+91" fallback below never actually fired for it. Forms defaulting
  // to "Select Country" showed a blank dial-code box until a real country
  // was chosen. Now falls back whenever the matched dial code is empty too.
  return c?.dial || "+91";
}
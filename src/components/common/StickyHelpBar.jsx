  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 flex gap-2 p-2 md:p-3 bg-white/90 backdrop-blur-xl border-t border-border/40 shadow-lg shadow-black/5">
      ...
      <a
        ...
        className="flex-1 flex items-center justify-center gap-2 py-2.5 sm:py-3 rounded-xl bg-[#00C853] hover:bg-[#00b848] text-white font-heading font-bold text-xs sm:text-sm transition-colors"
      >
